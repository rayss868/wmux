...
export function buildCommanderSystemPrompt(
  ...
  return [
    ...
    '  instruction wins; otherwise prefer the matching role; if no pane fits, use any',
    '  pane or spawn one. Before dispatching by role, call pane_list to get the target',
