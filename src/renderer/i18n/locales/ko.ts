export const ko = {
  ...
  'fanout.title': 'Fan-out — 프롬프트 1개 → N 격리 태스크',
  'fanout.promptLabel': '프롬프트',
  'fanout.promptPlaceholder': '모든 태스크가 받을 프롬프트…',
  'fanout.bytes': '{bytes} / {max} 바이트',
  'fanout.taskCount': '태스크 수 (N): {n}',
  'fanout.titlesLabel': '태스크별 제목 (편집 가능 — 브랜치·slug 식별)',
  'fanout.repoLabel': 'repo 경로',
  'fanout.agentLabel': 'agent 명령',
  'fanout.cancel': '취소',
  'fanout.spawning': '스폰 중…',
  'fanout.spawn': '{n}개 스폰',
  'fanout.errPromptRequired': 'fan-out: 프롬프트를 입력하세요',
