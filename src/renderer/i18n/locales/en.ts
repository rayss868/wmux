export const en = {
  ...
  'fanout.title': 'Fan-out — 1 prompt → N isolated tasks',
  'fanout.promptLabel': 'Prompt',
  'fanout.promptPlaceholder': 'Prompt every task will receive…',
  'fanout.bytes': '{bytes} / {max} bytes',
  'fanout.taskCount': 'Task count (N): {n}',
  'fanout.titlesLabel': 'Per-task titles (editable — branch/slug identity)',
  ...
  'fanout.errPromptRequired': 'fan-out: enter a prompt',
