export const zh = {
  ...
  'fanout.spawning': '生成中…',
  'fanout.spawn': '生成 {n} 个',
  'fanout.errPromptRequired': 'fan-out：请输入提示',
  ...
  'diff.taskNotFound': '未找到任务 — worktree 丢失或已损坏',
  ...
  'diff.closeConfirm': '关闭此任务？若为 clean，将移除 worktree 并归档任务通道。',
  'diff.closedUnmaterialized': '任务已关闭（未实体化 — 无 worktree）。',
  'diff.closedArchiveDeferred': '任务已关闭 — 通道归档已延后（启动时的 reconcile 将会收敛）。',
  'diff.closedFull': '任务已关闭 — 已移除 worktree 并归档通道。',
  ...
  'diff.prBusy': 'PR 中…',
  'diff.closeTitle': '关闭任务（若为 clean，移除 worktree · 归档通道）',
  'diff.closing': '关闭中…',
  'diff.close': '关闭',
  ...
  // ─── 工作区条目: 任务 worktree 边界警告 ───
  'workspace.cwdDeparted': '面板 cwd 已越出任务 worktree 边界：{cwd}',
